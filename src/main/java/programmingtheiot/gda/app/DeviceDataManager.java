...
/**
 * Handles all data collection, actuation and redirection complexities. 
 * This class is also responsible for directing the communications with the CDA
 *
 */
public class DeviceDataManager implements IDataMessageListener
{
	...
	/*Using ConfigUtil to retrieve communication connection enablement flags from the GatewayDevice section*/
	...
	// public methods
	//Implementing iDataMessageListener interface. These methods  
	//will be used as callback methods for use by any other class 
	//holding a reference to IDataMessageListener
	...
	//Method to invoke analysis functionality
	@Override
	 ...
	 * Initializes the connection objects that will be used to connect CDA and cloud services
	 */
	private void initManager()
	{
		...
		// Creating Mqtt client connector instance
